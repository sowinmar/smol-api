...
RSpec.describe 'Books API', type: :request do
  ...
  describe 'POST /books' do
    # valid payload
    let(:valid_attributes) { { title: 'Learn Elm', author: 'Elm', ISBN: '1234567890'} }
    ...
    context 'when the request is invalid' do
      ...
      it 'returns a validation failure message' do
        expect(response.body)
          .to match(/Validation failed: Author can't be blank, Isbn can't be blank/)
      end
    end
  end
  ...
  describe 'PUT /books/:id' do
    let(:valid_attributes) { { title: 'Karamazov' } }
